                                ...
                                <table class="table mt-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="font-size: 17px;" scope="col">First</th>
                                            <th style="font-size: 17px;" scope="col">Last</th>
                                            <th style="font-size: 17px;" scope="col">Handle</th>
                                        </tr>
                                    </thead>
                                    <tbody class="nowPlaying_tbody">
                                        <c:forEach var="p" items="${ListALLMovie}">
                                            <tr class="nowPlaying_tr">
                                                <td class="nowPlaying_item"></td>
                                                <td>${p.movieName}</td>
                                                <td>${p.category}</td>
                                                <td>${p.description}</td>
                                            </tr>
